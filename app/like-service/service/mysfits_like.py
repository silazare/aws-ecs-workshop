...
# load x-ray recorder module
from aws_xray_sdk.core import xray_recorder
# load middleware module for incoming requests
...
# x-ray recorder config to label segments as 'like service'
xray_recorder.configure(service='like service')
# initialize the x-ray middleware
